...
def create_question(question_text, days):
    """
    Create a question with the given 'question_text' published the given number of 'days' offset
...
class QuestionMethodsTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """ was_published_recently() should return False for qustions whose pub date is in the future. """
    ...
    def test_was_published_recently_with_old_question(self):
        """ was_published_recently() should return False for qustions whose pub_date is older than 1 day. """
        time = timezone.now() - datetime.timedelta(days = 30)
